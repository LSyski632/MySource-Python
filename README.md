US GPS Deployment and MySource are two Deloitte internal web sites that contain listings of open roles within Deloitte.  This repository contains several Python scripts designed to make the job search more efficient for the searcher.

The script process requires the searcher to download a spreadsheet from either or both of the web sites.
